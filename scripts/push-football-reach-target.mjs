...
const extraNames = [
  ...
  ['Tijjani', 'Reijnders', ['Fofana', 'Bennacer', 'Musah'], 'Manchester City & Netherlands silky midfielder'],
  ...
  ['Michele', 'Di Gregorio', ['Perin', 'Pinsoglio', 'Szczęsny'], 'Bournemouth & Italy agile goalkeeper'],
  ...
  ['Enzo', 'Le Fée', ['Cristante', 'Pellegrini', 'Koné'], 'Sunderland & France midfielder'],
