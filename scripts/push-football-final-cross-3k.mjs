...
const shootouts = [
  ...
  makeQ('Which former England manager famously had his crucial sudden-death penalty saved by Andreas Köpke in the Euro 1996 semi-final shootout vs Germany?', 'Gareth Southgate', ['Stuart Pearce', 'Paul Ince', 'Tony Adams'], 'world', 'penalty-shootouts'),
...
const namesFinal = [
  ...
  ['Nico', 'González', ['Varela', 'Grujić', 'Eustáquio'], 'Newcastle & Spain midfielder'],
  ...
  ['Florentino', 'Luís', ['Aursnes', 'Kökçü', 'Barreiro'], 'Ipswich Town & Portugal defensive anchor'],
  ...
  ['Ousmane', 'Diomande', ['Inácio', 'Debast', 'Quaresma'], 'Nottingham Forest & Ivory Coast AFCON champion centre-back'],
  ...
  ['Hidemasa', 'Morita', ['Hjulmand', 'Bragança', 'Kovacevic'], 'Hull City & Japan midfield conductor'],
  ['Geovany', 'Quenda', ['Catamo', 'Trincão', 'Santos'], 'Chelsea & Portugal wonderkid wing-back'],
