...
const moreNames = [
  ...
  ['Viktor', 'Gyökeres', ['Isak', 'Kulusevski', 'Elanga'], 'Arsenal & Sweden goal machine'],
  ['Anthony', 'Gordon', ['Barnes', 'Murphy', 'Almiron'], 'Newcastle & England winger'],
  ['Sandro', 'Tonali', ['Guimarães', 'Joelinton', 'Willock'], 'Tottenham & Italy midfielder'],
  ...
  ['Oscar', 'Bobb', ['Haaland', 'Sorloth', 'Nusa'], 'Fulham & Norway winger'],
  ...
  ['Omari', 'Hutchinson', ['Philogene', 'Delap', 'Clarke'], 'Nottingham Forest & Jamaica winger'],
  ['Liam', 'Delap', ['Hutchinson', 'Broadhead', 'Al-Hamadi'], 'Nottingham Forest & England striker'],
  ...
  ['Carlos', 'Baleba', ['Gilmour', 'Wieffer', 'Moder'], 'Manchester United & Cameroon midfielder'],
