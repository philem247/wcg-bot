...
const namePairs = [
  ...
  ['Takehiro', 'Tomiyasu', ['Mitoma', 'Endo', 'Minamino'], 'Crystal Palace & Japan defender'],
  ...
  ['Gianluigi', 'Donnarumma', ['Buffon', 'Sirigu', 'Vicario'], 'Manchester City & Italy goalkeeper'],
  ['Wojciech', 'Szczęsny', ['Fabiański', 'Skorupski', 'Grabara'], 'Barcelona & Poland goalkeeper'],
  ...
  ['Alejandro', 'Garnacho', ['Buonanotte', 'Almada', 'Barco'], 'Aston Villa & Argentina winger'],
  ['Cole', 'Palmer', ['Madueke', 'Chukwuemeka', 'Gallagher'], 'Chelsea & England playmaker'],
  ['Nicolas', 'Jackson', ['Dia', 'Sarr', 'Diallo'], 'Aston Villa & Senegal striker'],
  ['Malo', 'Gusto', ['Disasi', 'Badiashile', 'Ugochukwu'], 'Chelsea & France full-back'],
  ['Enzo', 'Fernández', ['Paredes', 'Palacios', 'Mac Allister'], 'Manchester City & Argentina midfielder'],
  ...
  ['Alexander', 'Isak', ['Gyökeres', 'Elanga', 'Larsson'], 'Liverpool & Sweden striker'],
  ['Bruno', 'Guimarães', ['Joelinton', 'Paquetá', 'Gomes'], 'Arsenal & Brazil midfielder'],
  ...
  ['Emiliano', 'Martínez', ['Rulli', 'Musso', 'Armani'], 'Chelsea & Argentina World Cup winning GK'],
  ['Morgan', 'Rogers', ['Ramsey', 'Philogene', 'Iling-Junior'], 'Chelsea & England forward'],
  ...
  ['Mohammed', 'Kudus', ['Partey', 'Sulemana', 'Nuamah'], 'Tottenham & Ghana attacker'],
  ['Jarrod', 'Bowen', ['Ward-Prowse', 'Antonio', 'Soucek'], 'West Ham & England winger'],
  ['Bryan', 'Mbeumo', ['Wissa', 'Onyeka', 'Schade'], 'Manchester United & Cameroon forward'],
  ['Yoane', 'Wissa', ['Bakambu', 'Elia', 'Bongonda'], 'Newcastle & DR Congo forward'],
  ['Rayan', 'Aït-Nouri', ['Bennacer', 'Mahrez', 'Bensebaini'], 'Manchester City & Algeria left-back'],
  ['Matheus', 'Cunha', ['Gomes', 'Lemina', 'Neto'], 'Manchester United & Brazil attacker'],
  ['João', 'Gomes', ['Andre', 'Danilo', 'Casemiro'], 'Wolves & Brazil midfielder'],
  ['Eberechi', 'Eze', ['Olise', 'Ayew', 'Schlupp'], 'Arsenal & England playmaker'],
  ['Jean-Philippe', 'Mateta', ['Edouard', 'Ayew', 'França'], 'Crystal Palace & France striker'],
  ['Marc', 'Guéhi', ['Andersen', 'Richards', 'Holding'], 'Manchester City & England defender'],
  ['Antoine', 'Semenyo', ['Kudus', 'Williams', 'Ayew'], 'Manchester City & Ghana forward'],
  ['Dominic', 'Solanke', ['Toney', 'Wilson', 'Bamford'], 'Tottenham & England striker'],
  ['Milos', 'Kerkez', ['Orban', 'Sallai', 'Nego'], 'Liverpool & Hungary left-back'],
  ...
  ['Martín', 'Zubimendi', ['Merino', 'Méndez', 'Turrientes'], 'Arsenal & Spain midfielder'],
  ...
  ['Florian', 'Wirtz', ['Musiala', 'Sané', 'Gnabry'], 'Liverpool & Germany playmaker'],
  ['Jeremie', 'Frimpong', ['Dumfries', 'Geertruida', 'Timber'], 'Liverpool & Netherlands wing-back'],
  ...
  ['Granit', 'Xhaka', ['Freuler', 'Zakaria', 'Aebischer'], 'Sunderland & Switzerland captain'],
  ...
  ['Xavi', 'Simons', ['Gakpo', 'Reijnders', 'Schouten'], 'Tottenham & Netherlands playmaker'],
  ['Loïs', 'Openda', ['Lukaku', 'Bakayoko', 'Doku'], 'RB Leipzig & Belgium forward'],
  ['Benjamin', 'Šeško', ['Iličić', 'Sporar', 'Vipotnik'], 'Manchester United & Slovenia tall striker'],
  ['Dani', 'Olmo', ['Pedri', 'Baena', 'Ruiz'], 'Barcelona & Spain Euro 2024 Golden Boot winner'],
  ['Bradley', 'Barcola', ['Dembele', 'Kolo Muani', 'Doue'], 'Liverpool & France rapid winger'],
