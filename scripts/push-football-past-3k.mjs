...
const completeNamesList = [
  ...
  ['Rayan', 'Cherki', ['Benrahma', 'Fofana', 'Nuamah'], 'Manchester City & France playmaker prodigy'],
  ['Ernest', 'Nuamah', ['Kudus', 'Sulemana', 'Semenyo'], 'Lyon & Ghana explosive winger'],
  ['Malick', 'Fofana', ['Nuamah', 'Cherki', 'Mangala'], 'Sunderland & Belgium dynamic attacker'],
  ['Mason', 'Greenwood', ['Rowe', 'Harit', 'Wahi'], 'Marseille forward'],
  ['Elye', 'Wahi', ['Moffi', 'Kalimuendo', 'Gouiri'], 'Marseille & France striker'],
  ['Gerónimo', 'Rulli', ['Musso', 'Armani', 'Benítez'], 'Manchester City & Argentina goalkeeper'],
  ...
  ['Arnaud', 'Kalimuendo', ['Gouiri', 'Blas', 'Jota'], 'Nottingham Forest & France striker'],
  ...
  ['Adrien', 'Truffert', ['Locko', 'Merlin', 'Hernandez'], 'Bournemouth & France full-back'],
  ...
  ['Thierno', 'Barry', ['Pérez', 'Pino', 'Moreno'], 'Everton & France young striker'],
  ['Yéremy', 'Pino', ['Baena', 'Pérez', 'Terrats'], 'Crystal Palace & Spain winger'],
...
for (const [player, correct, wrong] of moreFlagsWorldwide) {
