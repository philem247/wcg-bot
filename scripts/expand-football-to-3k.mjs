...
const namesExpansion = [
  ...
  ['Exequiel', 'Palacios', ['Andrich', 'Xhaka', 'García'], 'Ipswich Town & Argentina World Cup winner'],
  ['Robert', 'Andrich', ['Palacios', 'Hofmann', 'García'], 'Bayer Leverkusen & Germany midfielder'],
  ['Amine', 'Adli', ['Tella', 'Hofmann', 'Schick'], 'Bournemouth & Morocco winger'],
  ...
  ['Arthur', 'Vermeeren', ['Barrios', 'Koke', 'Gallagher'], 'RB Leipzig & Belgium young midfielder'],
  ...
  ['Jørgen', 'Strand Larsen', ['Sørloth', 'Haaland', 'Ajer'], 'Crystal Palace & Norway tall forward'],
  ...
  ['Brian', 'Brobbey', ['Weghorst', 'Zirkzee', 'Depay'], 'Sunderland & Netherlands explosive striker'],
...
for (const [player, correct, wrong] of flagsExpansion) {
